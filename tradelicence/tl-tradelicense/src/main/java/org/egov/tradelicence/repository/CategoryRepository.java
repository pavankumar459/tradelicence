...
public class CategoryRepository {
	...
	public List<Category> searchCategory(String tenantId, Integer[] ids, String name, String code, Integer pageSize,
		...
		List<Category> categories = geCategories(categorySearchQuery.toString(), preparedStatementValues);
	 ...
	 */
	private List<Category> geCategories(String query, List<Object> preparedStatementValues) {
