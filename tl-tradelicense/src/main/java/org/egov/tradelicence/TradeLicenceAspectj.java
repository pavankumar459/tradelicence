...
/**
 * This is aspectj class for tl-tradelicence
 * 
...
@Aspect
@Component
public class TradeLicenceAspectj {

	private static final Logger logger = LoggerFactory.getLogger(TradeLicenceApplication.class);
